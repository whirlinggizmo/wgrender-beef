...
Code running in the wasm allocates nothing on the JS heap itself, so those rows (667 to 1,343 B/frame here) are the page's own noise: Emscripten's glue, the page and the measuring. Their order means nothing.
